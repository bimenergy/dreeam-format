export default {
  ...
  buildingType: true,
  geometryType: true,
  geometryAttachment: true,
  averageStoreyHeight: true,
  hasBalconies: true,
  ...
  ventilationHeatExchange: {
    decimals: 1,
  },
  heatRecoveryToHotTapWater: {
    decimals: 1,
  },
  heatRecoveryHeatPump: {
    decimals: 1,
  },
  solarEnergyThroughWindow: {
    decimals: 1,
  },
  processEnergy: {
    decimals: 1,
  ...
  exteriorWallInsideMaterial: true,
  exteriorWallOutsideMaterial: true,
  exteriorWallRenovatedYear: true,
  exteriorWallRenovationDegree: true,
  roofRenovatedYear: true,
  roorIsRenovated: true,
  heatedAttic: true,
  windowsRenovatedYear: true,
  shadingLevel: true,
  heatingSystemRenovatedYear: true,
  powerOfBoiler: true,
  circuitTemperatures: true,
  circuitInsulation: true,
  hotWaterSystemType: true,
  accessToHeatingInfrastructureGas: true,
